...
namespace BlazorDemo.Services {
    class SupplierService {
        ...
        public Task<IEnumerable<SupplierCategory>> GetSupplierCategoriesAsync(CancellationToken ct = default) {
            return Task.FromResult(SupplierCategories.AsEnumerable());
        }
        public Task<IEnumerable<DeliveryMethod>> GetDeliveryMethodsAsync(CancellationToken ct = default) {
            return Task.FromResult(DeliveryMethods.AsEnumerable());
        }
