...
Declare the [DxHtmlEditor.Extensions](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxHtmlEditor.Extensions) property and populate it with AI-related toolbar items to integrate the corresponding commands into the HTML Editor.
