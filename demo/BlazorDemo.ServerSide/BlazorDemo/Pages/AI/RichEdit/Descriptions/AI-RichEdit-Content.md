...
2. Declare the [DxRichEdit.Extensions](https://docs.devexpress.com/Blazor/DevExpress.Blazor.RichEdit.DxRichEdit.Extensions) property and populate it with AI-related context menu items to integrate the corresponding commands into the Rich Text Editor.
