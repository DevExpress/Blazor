...
In this demo, validation is disabled. Once focus leaves the New Item Row, the TreeList adds the row to the data source. The [EditOnKeyPress](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxTreeList.EditOnKeyPress) property is enabled and row editing starts once you begin typing.
