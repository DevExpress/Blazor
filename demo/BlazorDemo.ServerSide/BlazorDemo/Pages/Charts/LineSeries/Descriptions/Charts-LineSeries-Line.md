...
The [DxChart](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChart-1) component allows you to add multiple series objects to component markup. Each series can specify its data via the [Data](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartXYSeries-4.Data) property.
