Full stacked spline series display values as percentages (you need to add more than one series of this type). The topmost series is always a horizontal line at 100%. Follow the steps below to create a full stacked spline series:
...
2. Add a [DxChartFullStackedSplineSeries](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartFullStackedSplineSeries-3) object to chart markup.
