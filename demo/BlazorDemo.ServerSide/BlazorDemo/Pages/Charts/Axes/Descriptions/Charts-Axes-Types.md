...
To change the type of an axis, use its [Type](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartArgumentAxis.Type) property. The following axis types are available:
