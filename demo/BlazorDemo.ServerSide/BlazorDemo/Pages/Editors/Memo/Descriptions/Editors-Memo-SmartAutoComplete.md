...
This demo adds our AI-powered [Smart Autocomplete extension](https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Editors.MemoSmartAutoComplete) into the DevExpress Blazor Memo component. The extension helps users compose text more efficiently. As users type, the AI service analyzes input and context, and generates relevant text suggestions.
...
1. [Register an AI service in your application](https://docs.devexpress.com/Blazor/405228/ai-powered-extensions#ai-services-integration).
