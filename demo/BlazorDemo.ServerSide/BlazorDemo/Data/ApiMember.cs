...
namespace BlazorDemo.Data {
    public class ApiMember {
        ...
        public static readonly ApiMember[] DxMenu = new[] {
            ...
            new ApiMember(){Name="ItemClick",Id="DevExpress.Blazor.DxMenu.ItemClick", ParentId="DxMenu.properties"},
            ...
            new ApiMember() { Name ="Items",Id="DevExpress.Blazor.DxMenu.Items", ParentId="DxMenu.events"},
            /*EndCollapse*/
        };
