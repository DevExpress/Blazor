...
namespace BlazorDemo.Data {
    public static class ComponentsData {
        private static readonly List<ComponentSet> componentSets =  new List<ComponentSet>() {
                new ComponentSet("Components", componentSets:
                    new List<ComponentSet>() {
                        new ComponentSet("Data Grid", GetImageUrl("grid"), "The DevExpress Data Grid for Blazor allows you to present and manage data in a tabular format."),
                        new ComponentSet("Pivot Grid", GetImageUrl("pivot"), "The DevExpress Pivot Grid for Blazor allows you to display and analyze multi-dimensional data from an underlying data source."),
                        new ComponentSet("Charts", GetImageUrl("chart"), "DevExpress Charts for Blazor help you transform data to its most appropriate, concise and readable visual representation."),
        ...
        public static List<ComponentSet> ComponentSets { get { return componentSets; } }
