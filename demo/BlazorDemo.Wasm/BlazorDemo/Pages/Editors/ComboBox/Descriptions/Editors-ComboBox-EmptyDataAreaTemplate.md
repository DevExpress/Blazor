...
Define the [EmptyDataAreaTemplate](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxComboBox-2.EmptyDataAreaTemplate) to customize content displayed in this empty region. The template's **context** parameter includes the [IsDataLoading](https://docs.devexpress.com/Blazor/DevExpress.Blazor.ListBoxEmptyDataAreaTemplateContext.IsDataLoading) property. This property allows you to determine whether ComboBox is still loading data.