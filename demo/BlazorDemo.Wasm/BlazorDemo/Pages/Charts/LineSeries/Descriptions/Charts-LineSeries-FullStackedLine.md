Full stacked line series display values as percentages (you need to add more than one series of this type). The topmost series is always a horizontal line at 100%. Follow the steps below to create a full stacked line series:
...
2. Add a [DxChartFullStackedLineSeries](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxChartFullStackedLineSeries-3) object to chart markup.
